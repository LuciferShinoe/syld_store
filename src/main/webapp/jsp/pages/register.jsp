        ...
        <div class="row">
            ...
            <div class="col-5 ">
                <div class="my__account__wrapper">
                    ...
                    <spForm:form method="post" action="register" modelAttribute="user_reg">
                        <div class="account__form">
                            ...
                            <p class="small fw-bold mt-2 pt-1 mb-0">I have a account. </p><a class="Register" href="login">Login.</a>
