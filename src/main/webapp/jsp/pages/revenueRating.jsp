            ...
            <div class="col-lg-12">
                <div class="breadcrumb__inner text-center">
                    ...
                    <nav class="breadcrumb-content">
                        ...
                        <span class="breadcrumb_item active">Revenue Rating</span>
                    </nav>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="gallery__menu">
                    <button data-filter="*" class="is-checked">Clothes</button>
                    <button data-filter=".cat--1">Perfume</button>
                    <button data-filter=".cat--2">Jewels</button>
                    <button data-filter=".cat--3">Shoes</button>
                    <button data-filter=".cat--4">Eyeglass</button>
                    <button data-filter=".cat--5">Fashion Accessories</button>
                </div>
            </div>
        </div>
