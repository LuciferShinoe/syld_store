        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section__title text-center">
                    <h2 class="title__be--2">Our <span class="color--theme">Events</span></h2>
                    <p>We always create offline event, desire everyone both have clothes with best quality are from our.</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-4 col-sm-12">
                <div class="post__itam">
                    <div class="content">
                        ...
                        <img src="${pageContext.request.contextPath}/assets/images/product/sm-img/1.jpg" width="300" height="300" alt="image"/>
            ...
            <div class="col-md-6 col-lg-4 col-sm-12">
                <div class="post__itam">
                    <div class="content">
                        ...
                        <img src="${pageContext.request.contextPath}/assets/images/product/sm-img/2.jpg" width="300" height="300" alt="image" />
            ...
            <div class="col-md-6 col-lg-4 col-sm-12">
                <div class="post__itam">
                    <div class="content">
                        ...
                        <img src="${pageContext.request.contextPath}/assets/images/product/sm-img/3.jpg" width="300" height="300" alt="image" />
