        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-default">
                    ...
                    <%--@elvariable id="size_edit" type=""--%>

                    <spForm:form enctype="multipart/form-data"
                                 action="${pageContext.request.contextPath}/admin/sizes/update" method="post"
                                 modelAttribute="size_edit">
                    <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12 mb-3">
                                            <spForm:input hidden="hidden" path="id" type="text"
                                                          class="form-control slug-title" value="${size_edit.id}"/>
