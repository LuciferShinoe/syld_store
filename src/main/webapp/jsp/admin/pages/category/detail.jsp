<div class="ec-content-wrapper">
    <div class="content">
        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            ...
            <div>
                <a href="product-list.html" class="btn btn-primary"> Detail
                </a>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <a href="javascript:0" class="text-secondary d-inline-block">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="d-flex mb-1">
                                                    ...
                                                    <span><span class="__cf_email__" data-cfemail="680d10090518040d280d05090104460b0705">[email&#160;protected]</span></span>
                                                </li>
                                                <li class="d-flex">
