<head>
    ...
    <meta name="description" content="SYLD - Admin Dashboard.">

    <title>SYLD - Admin Dashboard.</title>
    ...
    <!-- Ekka CSS -->
    <link id="ekka-css" href="${pageContext.request.contextPath}/assets/css/ekka.css" rel="stylesheet" />
